...
var tab = (0, _snabbdom.h)('ul', [(0, _snabbdom.h)('li', 'Rank'), (0, _snabbdom.h)('li', 'Title'), (0, _snabbdom.h)('li', 'Description')]);
var addBtn = (0, _snabbdom.h)('button', {
  on: {
    click: addItem
  }
}, 'Add');
var vnode = (0, _snabbdom.h)('div.container', [tab, addBtn, (0, _snabbdom.h)('ul.content', [])]);
...
function addItem() {
  index++;
  var newNode = (0, _snabbdom.h)('div.container', [tab, addBtn, (0, _snabbdom.h)('ul.content', [(0, _snabbdom.h)('li', [(0, _snabbdom.h)('span', index + 'Rank'), (0, _snabbdom.h)('button', {
    on: {
      click: delItem
    }
  }, '删除')])])]);
