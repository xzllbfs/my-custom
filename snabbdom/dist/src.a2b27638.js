...
var movies = [{
  ...
  rank: 10,
  name: 'Fight Club',
  description: 'An insomniac office worker looking for a way to changes his life crosses paths with a devil-may-care soap maker and they form an underground fight club that evolves into something much, much more...'
}];
var lastId = movies[movies.length - 1] ? movies[movies.length - 1].id + 1 : 1;
var oldVnode = null;

function view(data) {
  return (0, _snabbdom.h)('div.container', [(0, _snabbdom.h)('h1', 'Top 10 movies'), (0, _snabbdom.h)('div.header', [(0, _snabbdom.h)('span.left', 'Sort by:'), (0, _snabbdom.h)('ul.tab.left', [(0, _snabbdom.h)('li.btn', {
    on: {
      click: [showItem, 'rank']
    }
  }, 'Rank'), (0, _snabbdom.h)('li.btn', {
    on: {
      click: [showItem, 'name']
    }
  }, 'Title'), (0, _snabbdom.h)('li.btn', {
    on: {
      click: [showItem, 'description']
    }
  }, 'Description')]), (0, _snabbdom.h)('span.btn.right', {
    on: {
      click: addItem
    }
  }, 'Add')]), (0, _snabbdom.h)('ul.content', data.map(function (item) {
    return (0, _snabbdom.h)('li', {
      key: item.id
    }, [item.rank ? (0, _snabbdom.h)('span.rank', item.rank) : null, item.name ? (0, _snabbdom.h)('span.name', item.name) : null, item.description ? (0, _snabbdom.h)('span.description', item.description) : null, (0, _snabbdom.h)('span.right.close', {
      on: {
...
function showItem(key) {
  var filterMovies = movies.map(function (movie) {
    var obj = {};
    obj.id = movie.id;
    obj[key] = movie[key];
...
},{"snabbdom":"node_modules/snabbdom/es/snabbdom.js","snabbdom/modules/style":"node_modules/snabbdom/modules/style.js","snabbdom/modules/eventlisteners":"node_modules/snabbdom/modules/eventlisteners.js"}],"node_modules/_parcel-bundler@1.12.4@parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
